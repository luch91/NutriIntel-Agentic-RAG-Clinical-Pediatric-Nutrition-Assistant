...
CONDITION_ALIAS_MAP: Dict[str, str] = {
    ...
    "epilepsy/ketogenic": "epilepsy_keto",
    "epilepsy": "epilepsy_keto",
    "epilepsy_keto": "epilepsy_keto",
    "ketogenic": "epilepsy_keto",
    "ketogenic therapy": "epilepsy_keto",
    "ketogenic diet": "epilepsy_keto",
    "keto": "epilepsy_keto",
    "ibd": "gi_disorders",
    "gerd": "gi_disorders",
    "gi disorders": "gi_disorders",
    "gi_disorders": "gi_disorders",
    "inflammatory bowel disease": "gi_disorders",
    "crohn's disease": "gi_disorders",
    "ulcerative colitis": "gi_disorders",
}

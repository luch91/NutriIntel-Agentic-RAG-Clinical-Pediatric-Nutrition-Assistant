...
def optimize_diet(
    ...
    if prob.status != 1:
        return {"diet_plan": greedy_allocation(foods, targets), "note": "WARNING: Optimization failed, fallback to greedy allocation."}
    ...
    return {"diet_plan": plan, "note": "OK: Optimization succeeded"}
